...
if ( isset($_POST['add_customer']) ) {
	...
	if ( count($_SESSION['error_msg']) ) {
		header("Location: " . BASE_URL . "/admin/users.php#add-user");
		exit();
	}
...
if ( isset($_POST['edit_customer']) ) {
	...
	if ( count($_SESSION['error_msg']) ) {
		header("Location: " . BASE_URL . "/admin/users.php#edit-user-{$user_id}");
		exit();
	}
...
if ( isset($_POST['add_product']) ) {
	...
	if ( count($_SESSION['error_msg']) ) {
		header("Location: " . BASE_URL . "/admin/products.php#add-product");
		exit();
	}
	...
	echo $target_file;
	//$moved=move_uploaded_file(basename( $_FILES["product_image"]["tmp_name"]), $target_file);
	//exit(print_r($_FILES));
...
if ( isset($_POST['edit_product']) ) {
	...
	if ( count($_SESSION['error_msg']) ) {
		header("Location: " . BASE_URL . "/admin/products.php#edit-product-{$product_id}");
		exit();
	}
